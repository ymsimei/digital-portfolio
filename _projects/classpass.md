...
<div class="article">
  <div class="container overview">
    <div>
      <h3>Problem</h3>
      <p>
        Myself and two other UX Designers were tasked with building a new feature into ClassPass’s mobile app. For those unaware, ClassPass is a fitness membership that allows its users to choose from a wide variety of gyms and studios, ranging from yoga/pilates to spin classes. Users spend in-app credits in order to book classes.
      </p>
    </div>
    <div>
      <h3>Opportunity</h3>
  ...
  <div class="container">
    ...
    <div>
      <h3>Redefining Our Problem Statement</h3>
    </div>
    <div>
      <p>
